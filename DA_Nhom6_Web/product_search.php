            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <li><a class="dropdown-item" href="~/products/LocTheoLoai/1">Áo Thun</a></li>
                            <li><a class="dropdown-item" href="~/products/LocTheoLoai/2">Áo Khoác</a></li>
                            <li><a class="dropdown-item" href="~/products/LocTheoLoai/3">Quần Short</a></li>
                            <li><a class="dropdown-item" href="~/products/LocTheoLoai/4">Quần Dài</a></li>
                        </ul>
                    </li>
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <li><a class="dropdown-item" href="~/products/LocTheoMau/BLACK">BLACK</a></li>
                            <li><a class="dropdown-item" href="~/products/LocTheoMau/WHITE">WHITE</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
        ...
        <div class="row row-cols-4 " style="margin-left:30px">
            <?php foreach($data as  $product ):?>    
                    <div class="col" style=" margin-top:20px">  
                        <a href="detail.php?id=<?=$product['MaSp']?>" style="font-size: 12px; text-decoration: none; color:gray">
                            <div class="card-group">
                                <div class="card" style="width: 13rem; border: none; text-decoration: none; z-index: -100">

                                    <img src="<?=$product['HinhAnh'] ?>" class="card-img-top img-fluid hover-shadow" alt="..." style="width: 100%;height:30vh">

                                    <div class="card-body" style=" z-index: 100;height:20vh">
                                        <p class="card-text" style="font-size: 15px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;; "><?= $product['TenSP']?></p>
                                        <p class="card-text" style="font-size: 18px;"><?=  number_format($product['DonGia'], 0, ',','.') ?><sup>đ</sup></p>
                                    </div>
                                </div>
                            </div>
                        </a>                    
