            ...
            <div class="container text-center">
                <div class="row d-flex " style="height:10vh">
                    <div class="col   d-flex justify-content-start align-items-center m-lg-2">
                        <img src="https://cdn.haitrieu.com/wp-content/uploads/2022/09/Logo-Yame.png" style="width:60%;height:50px" />
                    </div>
                    <div class="col-7 mt-4 d-flex justify-content-end align-items-center">
                        ...
                        <?php endif ?>
                    <?php else:?>
                            <p  style=" text-decoration:none; color: red ;margin-left:20px">Chào bạn: <?php echo $_SESSION['name']  ?> </p>
                            <a style=" text-decoration:none; color: gray ;margin-left:20px" href="../logout.php"> Đăng Xuất </a>
                    <?php endif ?>
                        </p>
                    </div>
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <li class="nav-item">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" href="quanlyshop.php">QUẢN LÝ SHOP</a>
                            </li>
