...
if(!isset($_SESSION['login_detail'])){
    ...
    $user = Auth::getOneByID($pdo, $_SESSION['id']);
}
...
if (isset($_POST['delete'])) {
    ...
    $cart->delete($pdo,$ProductID, $_SESSION['id']);
    $order->delete($pdo,$ProductID, $_SESSION['id']);
    $cart_data = $cart->get($pdo,$_SESSION['id']);
...
if (isset($_POST['update'])) {
    ...
    $ProductID = $_POST['ProductID'];
    $Amount = $_POST['Amount'];
    $cart->update($pdo,$ProductID, $_SESSION['id'], $Amount);
    $order->update($pdo,$ProductID, $_SESSION['id'], $Amount);
    $cart_data = $cart->get($pdo,$_SESSION['id']);
...
if (isset($_POST['finish'])) {
    ...
    $cart->deleteAll($pdo, $_SESSION['id']);
                    ...
                    <div class="container-fluid" style="margin-bottom: 10vh;">
                        ...
                        <table class="table table-bordered">
                            ...
                            <tr>
                                ...
                                <td class="text-right"style="font-size: 18px;">Tổng thành tiền:<span style="color:red"> <?php echo $tongthanhtien   ?></span>  <sup>đ</sup></td>
                                <td>  <form action="" method="post">
                                            <div class="col-md-1 col-lg-1 col-xl-1 text-end">
                                                <input type="hidden" name="ProductID" value=" <?php echo $product['ProductID'] ?>">
                                                <button type="submit" name="finish" class="btn btn-primary" style="width: 200px; "><a href="" style="text-decoration:none;color:white">Thanh Toán</a> </button></td>
                                            </div>
                                        </form> </td>
                                <td>  
                            </tr>
...
<?php else: ?>
    ...
    <?php endif; ?>
<?php else: ?>
    <h2 style="margin-top: 30vh;"> <?=$error ?></h2>
